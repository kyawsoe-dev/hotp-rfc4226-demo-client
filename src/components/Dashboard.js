...
function Dashboard({ apiUrl, token, username, onLogout }) {
  ...
  const handleAddDevice = async () => {
    try {
      const res = await axios.post(`${apiUrl}/auth/add-device`, { username, deviceName: 'HOTP Device' });
        ...
        <div className="add-device-section">
          {!showAddDevice && (
            <div className="setup-2fa-section">
              <h3>Add HOTP Authenticator</h3>
              <p>Generate a QR code and scan it with your counter-based OTP authenticator app.</p>
